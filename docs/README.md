...
description: Overview of DevOnboarder documentation structure and navigation guide
document_type: overview
merge_candidate: false
project: DevOnboarder
similarity_group: README.md-docs
status: active
tags:
...
title: DevOnboarder Documentation Overview
...
- **Core Bootstrap**: [`.github/copilot-instructions.md`](../.github/copilot-instructions.md) - Essential project overview and critical policies

- **Modular Index**: [`MODULAR_DOCUMENTATION_INDEX.md`](MODULAR_DOCUMENTATION_INDEX.md) - Complete navigation guide to all 16 specialized modules

### 📚 Modular Structure Overview

#### 🛡️ Critical Policies (`docs/policies/`)

- [`terminal-output-policy.md`](policies/terminal-output-policy.md) - ZERO TOLERANCE terminal hanging prevention

- [`virtual-environment-policy.md`](policies/virtual-environment-policy.md) - Mandatory isolation requirements

- [`potato-policy.md`](policies/potato-policy.md) - Enhanced security file protection

- [`quality-control-policy.md`](policies/quality-control-policy.md) - 95% quality threshold validation
...
- [`development-workflow.md`](development/development-workflow.md) - Complete development workflow guidelines

- [`code-quality-requirements.md`](development/code-quality-requirements.md) - Linting rules and testing standards

- [`file-structure-conventions.md`](development/file-structure-conventions.md) - Directory layout and organization
...
- [`ci-cd-automation.md`](integration/ci-cd-automation.md) - GitHub Actions and automation ecosystem
...
- [`devonboarder-key-systems.md`](troubleshooting/devonboarder-key-systems.md) - Key systems and utilities guide
