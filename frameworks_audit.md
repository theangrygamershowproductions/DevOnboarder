# Frameworks Audit (2025-09-24T19:08:03UTC)

Root: \033[0;34mframeworks\033[0m
...
## Legacy Path Reference Scan (underscore→hyphen)
### \033[0;34mbuild-deployment\033[0m → \033[0;34mbuild-deployment\033[0m
```text
...
### \033[0;34mmonitoring-automation\033[0m → \033[0;34mmonitoring-automation\033[0m
```text
...
### \033[0;34mquality-assurance\033[0m → \033[0;34mquality-assurance\033[0m
```text
...
### \033[0;34mbuild-deployment\033[0m
#### Shell Scripts Found:
```text
...
```
- **sync_env_variables.sh**: \033[1;33m[WEAK ERROR HANDLING]\033[0m
- **smart_env_sync.sh**: \033[1;33m[WEAK ERROR HANDLING]\033[0m
...
- **env_security_audit.sh**: \033[1;33m[WEAK ERROR HANDLING]\033[0m
- **next_steps_deployment.sh**: \033[1;33m[WEAK ERROR HANDLING]\033[0m
...
### \033[0;34mmonitoring-automation\033[0m
#### Shell Scripts Found:
```text
analyze_ci_patterns.sh
...
- **assess_pr_health.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
...
- **analyze_ci_patterns.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **monitor_duplication.sh**: \033[1;33m[HERE-DOC SYNTAX]\033[0m \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **analyze_failed_ci_runs.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **workflow_health_validator.sh**: \033[1;33m[INCOMPLETE LOGGING: NO_SCRIPT_NAME_IN_LOG ]\033[0m
- **monitor_ci_health.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **orchestrate-staging.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **execute_automation_plan.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
...
- **automate_pr_process.sh**: \033[1;33m[INCOMPLETE LOGGING: NO_SCRIPT_NAME_IN_LOG ]\033[0m
- **fix_markdown_compliance_automation.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
- **final_automation_execution.sh**: \033[0;31m[NOT USING CENTRALIZED LOGGING]\033[0m
...
### \033[0;34mquality-assurance\033[0m
#### Shell Scripts Found:
```text
qc_docs.sh
qc_pre_push.sh
...
|---|:---:|:---:|:---:|
| \033[0;34mbuild-deployment\033[0m | \033[0;31m[NO]\033[0m | \033[0;32m[YES]\033[0m | \033[0;31m[NO]\033[0m |
| \033[0;34mmonitoring-automation\033[0m | \033[0;31m[NO]\033[0m | \033[0;32m[YES]\033[0m | \033[0;31m[NO]\033[0m |
| \033[0;34mquality-assurance\033[0m | \033[0;31m[NO]\033[0m | \033[0;32m[YES]\033[0m | \033[0;31m[NO]\033[0m |

------------------------------------------------------------------

## Summary

**Audit completed at 2025-09-24T19:08:05UTC**

- Frameworks scanned: 3
- Total scripts found: 79
