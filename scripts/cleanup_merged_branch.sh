...
cleanup_local_branches() {
    ...
    if [[ -n "$merged_branches" ]]; then
        ...
        success "Local branches cleaned up"
    fi
}

# Function to clean up remote tracking branches
cleanup_remote_branches() {
    web "Cleaning up remote tracking branches..."

    echo "   Pruning remote tracking branches..."
    git remote prune origin

    success "Remote tracking branches cleaned up"
}

# Function to update main branch
update_main_branch() {
    sync "Updating main branch..."
...
show_summary() {
    ...
    success "Post-merge cleanup complete"
}
