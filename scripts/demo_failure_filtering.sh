...
echo "   gh run list --conclusion FAILURE --limit 10"
echo ""
echo "   # Get detailed failed run data"
echo "   gh run list --conclusion FAILURE --json conclusion,workflowName,createdAt,url"
echo ""
echo "   # Failed runs for specific workflow"
echo "   gh run list -w 'Enhanced Potato Policy Enforcement' --conclusion FAILURE"
echo ""
