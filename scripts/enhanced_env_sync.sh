...
# Source the original smart_env_sync.sh for helper functions
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=scripts/smart_env_sync.sh disable=SC1091
source "$SCRIPT_DIR/smart_env_sync.sh"
